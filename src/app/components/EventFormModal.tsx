...
export function EventFormModal({ isOpen, onClose, eventToEdit, onSuccess }: EventFormModalProps) {
  ...
  return (
    <AnimatePresence>
      <div className="fixed inset-0 z-[110] flex items-start justify-center p-4 overflow-y-auto py-10 sm:py-20 scrollbar-hide">
        <motion.div
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
          exit={{ opacity: 0 }}
        ...
        <motion.div
          ...
          className="relative w-full max-w-2xl bg-white rounded-[32px] shadow-2xl flex flex-col mx-4 my-auto"
        >
          {/* Header */}
