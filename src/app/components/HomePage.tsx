...
const stageContent = {
  planning: {
    ...
    sections: [
      ...
      { icon: '/assets/icons/custom/luggage.png', title: 'Актуальные объявления: жильё, услуги', subtitle: 'Объявления', link: '/announcements', color: 'text-dusty-indigo', bg: 'bg-dusty-indigo/10' },
  ...
  living: {
    ...
    quickLinks: [
      ...
      { text: 'Найти своих', icon: '/assets/icons/custom/palm_tree_bw.png', link: '/people' },
      { text: 'Получить совет', icon: '/assets/icons/custom/message.png', link: '/support' },
    ],
    sections: [
      { icon: '/assets/icons/custom/luggage.png', title: 'Самое актуальное на первое время', subtitle: 'Объявления', link: '/announcements', color: 'text-terracotta-deep', bg: 'bg-terracotta-deep/10' },
  ...
  helping: {
    ...
    quickLinks: [
      { text: 'Помочь новичкам', icon: '/assets/icons/custom/palm_tree_bw.png', link: '/people?filter=newcomers' },
    ...
    sections: [
      { icon: '/assets/icons/custom/palm_tree_bw.png', title: 'Люди, которым ты можешь помочь', subtitle: 'Люди рядом', link: '/people', color: 'text-dusty-indigo', bg: 'bg-dusty-indigo/10' },
  ...
  leaving: {
    ...
    sections: [
      { icon: '/assets/icons/custom/luggage.png', title: 'Продать то, что не влезет в чемодан', subtitle: 'Объявления', link: '/announcements', color: 'text-dusty-indigo', bg: 'bg-dusty-indigo/10' },
