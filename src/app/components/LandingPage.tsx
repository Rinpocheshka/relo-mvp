  ...
  },
  {
    ...
    footer: (
      <div className="space-y-5 pt-3">
        <div className="bg-blue-50/50 border border-blue-200/60 rounded-2xl p-4 flex gap-3 text-sm text-blue-900/80">
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-3">
            <div 
              ...
              className="flex items-center justify-center gap-2 p-3.5 rounded-2xl bg-black text-white hover:bg-black/80 transition-all cursor-pointer"
            >
              <div className="w-5 h-5 flex items-center justify-center">
                <svg viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4"><path d="M17.05 20.28c-.96.95-2.23 1.5-3.5 1.5-2.07 0-3.5-1.15-5.07-1.15-1.57 0-3.14 1.15-5.07 1.15-1.27 0-2.54-.55-3.5-1.5-2.12-2.12-2.12-5.54 0-7.66 1.12-1.12 2.64-1.74 4.23-1.74 1.5 0 2.8.85 3.84.85 1.04 0 2.34-.85 3.84-.85 1.59 0 3.11.62 4.23 1.74 2.12 2.12 2.12 5.54 0 7.66zM12.03 7.25c-.15-2.23 1.66-4.07 3.9-4.22.15 2.23-1.66 4.07-3.9 4.22z"/></svg>
              </div>
              <span className="font-bold text-[11px] tracking-tight">App Store</span>
            </div>
            <div 
              onClick={() => window.open('https://play.google.com/store/apps/details?id=com.zing.zalo', '_blank')} 
              className="flex items-center justify-center gap-2 p-3.5 rounded-2xl bg-[#00A2EE] text-white hover:bg-[#0091d6] transition-all cursor-pointer"
            >
              <div className="w-5 h-5 flex items-center justify-center">
                <svg viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4"><path d="M3 20.5V3.5C3 2.91 3.34 2.39 3.84 2.15L13.69 12L3.84 21.85C3.34 21.61 3 21.09 3 20.5M16.81 15.12L18.05 16.36C18.44 16.75 18.44 17.38 18.05 17.77C17.66 18.16 17.03 18.16 16.64 17.77L15.39 16.52L16.81 15.12M16.81 8.88L15.39 7.48L16.64 6.23C17.03 5.84 17.66 5.84 18.05 6.23C18.44 6.62 18.44 7.25 18.05 7.64L16.81 8.88M14.5 12.81L4.65 22.66C4.84 22.88 5.14 23 5.5 23C5.81 23 6.1 22.92 6.34 22.78L18.44 15.86C19.12 15.47 19.5 14.77 19.5 14C19.5 13.23 19.12 12.53 18.44 12.14L6.34 5.22C6.1 5.08 5.81 5 5.5 5C5.14 5 4.84 5.12 4.65 5.34L14.5 11.19V12.81Z"/></svg>
              </div>
              <span className="font-bold text-[11px] tracking-tight">Play Market</span>
            </div>
          </div>
          <div className="bg-amber-50/50 border border-amber-200/60 rounded-2xl p-4 flex gap-3 text-[13px] text-amber-900/80">
            ...
            <p>Установить и войти в приложение лучше сразу в офисе где покупали сим-карту, так как могут возникнуть трудности при первоначальной регистрации.</p>
          </div>
        </div>
      </div>
    ),
                        ...
                        {openCard === i && (
                          <motion.div initial={{ height: 0, opacity: 0 }} animate={{ height: 'auto', opacity: 1 }} exit={{ height: 0, opacity: 0 }} transition={{ duration: 0.2 }} className="overflow-hidden">
                            <div className="px-6 pb-6 pt-2 space-y-5 border-t border-border/40 mt-1">
                              ...
                              {card.footer && (
                                <div className="text-foreground/90 leading-relaxed text-sm pt-2">
                                  {card.footer}
                                </div>
                              )}
                              <div className="pt-2">
