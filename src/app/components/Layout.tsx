          ...
          <div className="grid md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2.5">
                ...
                <li><a href="https://tally.so/r/VL106N" target="_blank" rel="noopener noreferrer" className="text-sm text-muted-foreground hover:text-terracotta-deep transition-colors">Хочу relome в моем городе</a></li>
              </ul>
            </div>
